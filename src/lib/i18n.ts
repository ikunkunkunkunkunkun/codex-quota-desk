...
export const copy = {
  "zh-CN": {
    ...
    active: "额度正在使用",
    availableLabel: (percent: number) => `周额度剩余 ${percent}%`,
    ...
    dataStale: "额度数据已过期",
    dateUnknown: "日期未知",
    errorUnavailable: "额度服务暂时不可用，将自动重试。",
    loadingQuota: "正在读取额度",
    noCreditExpiration: "当前接口只返回了次数，没有返回到期时间。",
    notSignedIn: "未登录",
    pinOff: "取消置顶",
    pinOn: "置顶显示",
    refresh: "刷新",
    ...
    view: "查看",
    weeklyRemaining: "周额度",
    weeklyUntil: (date: string) => `下次重置 / ${date}`,
  },
  en: {
    accountFallback: "ACCOUNT",
    active: "Quota in use",
    ...
    weeklyUntil: (date: string) => `Next reset / ${date}`,
  },
} as const;
