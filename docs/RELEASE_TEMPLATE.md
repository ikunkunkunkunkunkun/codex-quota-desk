# Codex Quota Desk 0.1.0

Codex Quota Desk is a personal floating desktop widget for checking Codex quota from the local Codex Desktop login state.

## Downloads

- Windows unsigned: `codex-quota-desk-windows-unsigned.zip`
- macOS Universal unsigned: `codex-quota-desk-macos-universal-unsigned.zip`
...
Codex Quota Desk does not store Codex tokens, account IDs, prompts, chats, raw quota responses, or local auth paths. It stores only widget preferences. See `PRIVACY.md`.
